...
export default function Footer() {
    return (
        <>
            <section className='footer mt-5 pb-3'>
                <div className="container">
                    <div className="row pt-5 pt-4">
                        <div className="col-lg-8">
                            ...
                            <div className="contact_address">
                                <div className="phone-num d-flex align-items-center mb-2 mt-4">
                                   <span className='me-2'><img src={phone} alt="Phone" /></span> <a href="tel:+1 568 512 54 74">+1 568 512 54 74</a>
                                </div>
                                <div className="mail d-flex align-items-center">
                                   <span className='me-2'>
                                    <img src={mail} alt="mail" /></span> <a href="mailto:youremail@email.com">youremail@email.com</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <ul className='social d-flex mb-4'>
                                <li>
                            ...
                            <div className="copy_right">
                                <div className='all_right mt-5 '>All rights reserved @ 2022</div>
                                <ul className='d-flex terms_link mt-2'>
